...
/**
 * This is the item provider adapter for a {@link metaModel.viewType.repository.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RepositoryPackage.Literals.COMPONENT__REQUIRES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addProvidesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Component_provides_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Component_provides_feature", "_UI_Component_type"),
				 RepositoryPackage.Literals.COMPONENT__PROVIDES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RepositoryPackage.Literals.COMPONENT__DESCRIPTION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RepositoryPackage.Literals.COMPONENT__DESCRIPTION,
				 RepositoryFactory.eINSTANCE.createBehaviourDescription()));
	}
