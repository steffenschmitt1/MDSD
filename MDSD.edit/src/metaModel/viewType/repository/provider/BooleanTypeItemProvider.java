...
/**
 * This is the item provider adapter for a {@link metaModel.viewType.repository.BooleanType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanTypeItemProvider extends SimpleTypeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BooleanType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BooleanType_type_feature", "_UI_BooleanType_type"),
				 RepositoryPackage.Literals.BOOLEAN_TYPE__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Boolean labelValue = ((BooleanType)object).getType();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BooleanType.class)) {
			case RepositoryPackage.BOOLEAN_TYPE__TYPE:
