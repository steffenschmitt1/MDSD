...
/**
 * This is the item provider adapter for a {@link metaModel.viewType.repository.MapType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MapTypeItemProvider extends SimpleTypeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MapType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MapType_type_feature", "_UI_MapType_type"),
				 RepositoryPackage.Literals.MAP_TYPE__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		EList labelValue = ((MapType)object).getType();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MapType.class)) {
			case RepositoryPackage.MAP_TYPE__TYPE:
