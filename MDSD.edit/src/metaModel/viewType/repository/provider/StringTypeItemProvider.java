...
/**
 * This is the item provider adapter for a {@link metaModel.viewType.repository.StringType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringTypeItemProvider extends SimpleTypeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StringType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StringType_type_feature", "_UI_StringType_type"),
				 RepositoryPackage.Literals.STRING_TYPE__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((StringType)object).getType();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StringType.class)) {
			case RepositoryPackage.STRING_TYPE__TYPE:
