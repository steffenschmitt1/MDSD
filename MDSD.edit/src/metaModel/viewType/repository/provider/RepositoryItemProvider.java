...
/**
 * This is the item provider adapter for a {@link metaModel.viewType.repository.Repository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepositoryItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RepositoryPackage.Literals.REPOSITORY__INTERFACE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Repository.class)) {
			...
			case RepositoryPackage.REPOSITORY__INTERFACE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RepositoryPackage.Literals.REPOSITORY__INTERFACE,
