...
/**
 * This is the item provider adapter for a {@link metaModel.viewType.environment.Container} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_allocationContext_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_allocationContext_feature", "_UI_Container_type"),
				 EnvironmentPackage.Literals.CONTAINER__ALLOCATION_CONTEXT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLinksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Container_links_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Container_links_feature", "_UI_Container_type"),
				 EnvironmentPackage.Literals.CONTAINER__LINKS,
				 true,
				 false,
				 true,
				 null,
