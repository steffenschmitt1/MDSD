...
/**
 * This is the item provider adapter for a {@link metaModel.viewType.assembly.RequiredRole} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RequiredRole_delegationConnector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RequiredRole_delegationConnector_feature", "_UI_RequiredRole_type"),
				 AssemblyPackage.Literals.REQUIRED_ROLE__DELEGATION_CONNECTOR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAssemblyConnectorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RequiredRole_assemblyConnector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RequiredRole_assemblyConnector_feature", "_UI_RequiredRole_type"),
				 AssemblyPackage.Literals.REQUIRED_ROLE__ASSEMBLY_CONNECTOR,
				 true,
				 false,
				 true,
				 null,
