...
/**
 * This is the item provider adapter for a {@link metaModel.ComponentBasedSystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentBasedSystemItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetaModelPackage.Literals.COMPONENT_BASED_SYSTEM__REPOSITORIES);
			childrenFeatures.add(MetaModelPackage.Literals.COMPONENT_BASED_SYSTEM__ENIVRONMENTS);
			childrenFeatures.add(MetaModelPackage.Literals.COMPONENT_BASED_SYSTEM__SYSTEMS);
			childrenFeatures.add(MetaModelPackage.Literals.COMPONENT_BASED_SYSTEM__ALLOCATION_CONTEXTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetaModelPackage.Literals.COMPONENT_BASED_SYSTEM__REPOSITORIES,
				 RepositoryFactory.eINSTANCE.createRepository()));

		newChildDescriptors.add
			(createChildParameter
				(MetaModelPackage.Literals.COMPONENT_BASED_SYSTEM__ENIVRONMENTS,
				 EnvironmentFactory.eINSTANCE.createEnivronment()));

		newChildDescriptors.add
			(createChildParameter
				(MetaModelPackage.Literals.COMPONENT_BASED_SYSTEM__SYSTEMS,
				 AssemblyFactory.eINSTANCE.createSystem()));

		newChildDescriptors.add
			(createChildParameter
				(MetaModelPackage.Literals.COMPONENT_BASED_SYSTEM__ALLOCATION_CONTEXTS,
