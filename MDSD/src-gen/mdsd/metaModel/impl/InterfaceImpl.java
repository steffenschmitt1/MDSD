 ...
 * </p>
 * <ul>
 *   <li>{@link mdsd.metaModel.impl.InterfaceImpl#getName <em>Name</em>}</li>
 *   <li>{@link mdsd.metaModel.impl.InterfaceImpl#getSignatures <em>Signatures</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceImpl extends MinimalEObjectImpl.Container implements Interface {
	...
	protected EClass eStaticClass() {
		return MetaModelPackage.Literals.INTERFACE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetaModelPackage.INTERFACE__NAME, oldName, name));
	}
	...
	public EList<Signature> getSignatures() {
		if (signatures == null) {
			signatures = new EObjectResolvingEList<Signature>(Signature.class, this,
					MetaModelPackage.INTERFACE__SIGNATURES);
		}
		return signatures;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case MetaModelPackage.INTERFACE__NAME:
			return getName();
		case MetaModelPackage.INTERFACE__SIGNATURES:
