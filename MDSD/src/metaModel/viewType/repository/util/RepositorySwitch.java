...
public class RepositorySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RepositoryPackage.PARAMETER_TYPE: {
			...
			case RepositoryPackage.MAP_TYPE: {
				...
				if (result == null) result = caseSimpleType(mapType);
				if (result == null) result = caseParameterType(mapType);
			...
			case RepositoryPackage.BOOLEAN_TYPE: {
				...
				if (result == null) result = caseParameterType(booleanType);
			...
			case RepositoryPackage.LIST_TYPE: {
				...
				if (result == null) result = caseSimpleType(listType);
			...
			case RepositoryPackage.DATE_TYPE: {
				...
				if (result == null) result = caseParameterType(dateType);
			...
			case RepositoryPackage.LONG_TYPE: {
				...
				if (result == null) result = caseParameterType(longType);
			...
			case RepositoryPackage.FLOAT_TYPE: {
				...
				if (result == null) result = caseParameterType(floatType);
			...
			case RepositoryPackage.CHAR_TYPE: {
				...
				if (result == null) result = caseSimpleType(charType);
				if (result == null) result = caseParameterType(charType);
