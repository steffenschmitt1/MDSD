 ...
 * </p>
 * <ul>
 *   <li>{@link metaModel.viewType.repository.impl.RepositoryImpl#getComponents <em>Components</em>}</li>
 *   <li>{@link metaModel.viewType.repository.impl.RepositoryImpl#getInterface <em>Interface</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RepositoryImpl extends MinimalEObjectImpl.Container implements Repository {
	...
	public EList<Interface> getInterface() {
		if (interface_ == null) {
			interface_ = new EObjectContainmentEList<Interface>(Interface.class, this, RepositoryPackage.REPOSITORY__INTERFACE);
		}
		return interface_;
	}
