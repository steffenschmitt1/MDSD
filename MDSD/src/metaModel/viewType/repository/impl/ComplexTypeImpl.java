 ...
 * </p>
 * <ul>
 *   <li>{@link metaModel.viewType.repository.impl.ComplexTypeImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComplexTypeImpl extends ParameterTypeImpl implements ComplexType {
	/**
	...
	public EList<ParameterType> getTypes() {
		if (types == null) {
			types = new EObjectContainmentEList<ParameterType>(ParameterType.class, this, RepositoryPackage.COMPLEX_TYPE__TYPES);
		}
		return types;
	}
