/**
 */
package metaModel.viewType.environment.util;
 ...
 * <!-- end-user-doc -->
 * @see metaModel.viewType.environment.EnvironmentPackage
 * @generated
 */
public class EnvironmentAdapterFactory extends AdapterFactoryImpl {
	...
	protected EnvironmentSwitch<Adapter> modelSwitch =
		new EnvironmentSwitch<Adapter>() {
			...
			@Override
			public Adapter caseEnivronment(Enivronment object) {
				return createEnivronmentAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link metaModel.viewType.environment.Container <em>Container</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link metaModel.viewType.environment.Link <em>Link</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link metaModel.viewType.environment.Enivronment <em>Enivronment</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEnivronmentAdapter() {
		return null;
	}
