...
import kit.mdsd.xtext.dsl.formatting2.DslFormatter;
import kit.mdsd.xtext.dsl.generator.DslGenerator;
import kit.mdsd.xtext.dsl.parser.antlr.DslAntlrTokenFileProvider;
import kit.mdsd.xtext.dsl.parser.antlr.DslParser;
import kit.mdsd.xtext.dsl.parser.antlr.internal.InternalDslLexer;
import kit.mdsd.xtext.dsl.scoping.DslScopeProvider;
import kit.mdsd.xtext.dsl.serializer.DslSemanticSequencer;
import kit.mdsd.xtext.dsl.serializer.DslSyntacticSequencer;
import kit.mdsd.xtext.dsl.services.DslGrammarAccess;
import kit.mdsd.xtext.dsl.validation.DslConfigurableIssueCodesProvider;
import kit.mdsd.xtext.dsl.validation.DslValidator;
...
public abstract class AbstractDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "kit/mdsd/xtext/dsl/Dsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("kit.mdsd.xtext.dsl.Dsl");
	}
