...
public class DslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getComponentAccess().getGroup_0(), "rule__Component__Group_0__0");
			builder.put(grammarAccess.getComponentAccess().getGroup_0_4(), "rule__Component__Group_0_4__0");
			builder.put(grammarAccess.getComponentAccess().getGroup_0_4_3(), "rule__Component__Group_0_4_3__0");
			builder.put(grammarAccess.getComponentAccess().getGroup_0_5(), "rule__Component__Group_0_5__0");
			builder.put(grammarAccess.getComponentAccess().getGroup_0_5_3(), "rule__Component__Group_0_5_3__0");
			builder.put(grammarAccess.getComponentAccess().getGroup_0_6(), "rule__Component__Group_0_6__0");
			...
			builder.put(grammarAccess.getComponentAccess().getNameAssignment_0_2(), "rule__Component__NameAssignment_0_2");
			builder.put(grammarAccess.getComponentAccess().getRequiresAssignment_0_4_2(), "rule__Component__RequiresAssignment_0_4_2");
			builder.put(grammarAccess.getComponentAccess().getRequiresAssignment_0_4_3_1(), "rule__Component__RequiresAssignment_0_4_3_1");
			builder.put(grammarAccess.getComponentAccess().getProvidesAssignment_0_5_2(), "rule__Component__ProvidesAssignment_0_5_2");
			builder.put(grammarAccess.getComponentAccess().getProvidesAssignment_0_5_3_1(), "rule__Component__ProvidesAssignment_0_5_3_1");
			builder.put(grammarAccess.getComponentAccess().getDescriptionAssignment_0_6_1(), "rule__Component__DescriptionAssignment_0_6_1");
